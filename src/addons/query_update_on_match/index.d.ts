...
export declare function queryUpdateOnMatch<T>(param: IQueryUpdateOnMatchParam<T>): import("rxjs/internal/Observable").Observable<[IOkPacket, import("mysql").FieldInfo[] | undefined]>;
