...
export declare function querySelectOnMatch<T, U>(param: IQuerySelectOnMatchParam<T>): import("rxjs/internal/Observable").Observable<[U[], import("mysql").FieldInfo[] | undefined]>;
