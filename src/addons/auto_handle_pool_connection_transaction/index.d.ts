 ...
 */
export declare function autoHandlePoolConnectionTransaction<T>(pool: Pool, queryConnHigherOrder: queryConnHigherOrder<T>): import("rxjs/internal/Observable").Observable<T>;
