...
it('should commit and return result of query', (done) => {
    ...
    const mockCommit = query_commit_transaction_1.queryCommitTransaction
        .mockReturnValue(rxjs_1.of('commit'));
    const mockRollback = query_rollback_transaction_1.queryRollbackTransaction
        .mockReturnValue(rxjs_1.of('rollback'));
    const mockStart = query_start_transaction_1.queryStartTransaction
        .mockReturnValue(rxjs_1.of('start'));
